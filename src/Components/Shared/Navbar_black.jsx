...
const Navbar_black = () => {
    ...
    return (
        ...
        <div className=" navbar px-16 text-black font-semibold">
            ...
            <div className="navbar-center hidden lg:flex">
                <div className="form-control mr-4">
                    <input type="text" placeholder="Search" className="input input-bordered w-24 md:w-auto border border-black bg-transparent" />
                </div>
